...
namespace bammm
{
	...
	virtual IStateCallback::~IStateCallback()
	{

	}

	virtual void IStateCallback::switchState(State* current, State* newState)
	{
		cout << "wrong switch" << endl;
	}
	virtual void IStateCallback::switchState(State* current,
